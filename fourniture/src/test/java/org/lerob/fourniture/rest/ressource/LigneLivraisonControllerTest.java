...
import org.lerob.fourniture.service.LigneLivraisonService;
...
class LigneLivraisonControllerTest {
    ...
    void listeLigneLivraison() {
        // Données de test
        LigneLivraisonDto
            lignelivraison1 = LigneLivraisonDto.builder().id(1L).qteLivraison(Double.valueOf(9)).etatLivraison("VA").build();
